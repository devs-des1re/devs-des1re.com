...
if (!isset($_SESSION["redirected"])) {
    header("Location: /devs-des1re.com/404");
    exit;
}
...
<head>
    ...
    <title>devs-des1re - Success!</title>
...
<body class="bg-[#F5F5F5] font-['Cascadia_Mono'] min-h-screen flex flex-col">
    ...
    <!-- 404 ERROR -->
    <main class="flex flex-col items-center justify-center min-h-[60vh] px-10 py-10">
        <div class="flex flex-col items-center text-center mx-auto">
            <div class="flex flex-col items-center mx-auto text-center">
                <p class="p-3 text-sm font-medium text-[#0099FF] rounded-full bg-blue-100">
                    <svg xmlns="http://www.w3.org/2000/svg" width="23.25" height="24" viewBox="0 0 496 512"><path fill="#0099FF" d="M248 8C111 8 0 119 0 256s111 248 248 248s248-111 248-248S385 8 248 8m0 448c-110.3 0-200-89.7-200-200S137.7 56 248 56s200 89.7 200 200s-89.7 200-200 200m-80-216c17.7 0 32-14.3 32-32s-14.3-32-32-32s-32 14.3-32 32s14.3 32 32 32m160 0c17.7 0 32-14.3 32-32s-14.3-32-32-32s-32 14.3-32 32s14.3 32 32 32m4 72.6c-20.8 25-51.5 39.4-84 39.4s-63.2-14.3-84-39.4c-8.5-10.2-23.7-11.5-33.8-3.1c-10.2 8.5-11.5 23.6-3.1 33.8c30 36 74.1 56.6 120.9 56.6s90.9-20.6 120.9-56.6c8.5-10.2 7.1-25.3-3.1-33.8c-10.1-8.4-25.3-7.1-33.8 3.1"/></svg>
                </p>

                <h1 class="mt-3 text-2xl font-semibold text-[#1C1C1C] md:text-3xl">Success!</h1>
                <p class="mt-4 text-[#4D4D4D]">The task has been successfully completed!</p>

                <div class="flex items-center w-full mt-6 gap-x-3 shrink-0 sm:w-auto">
                    <button class="w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-[#0099FF] rounded-lg shrink-0 sm:w-auto hover:bg-blue-600">
