...
<head>
    ...
    <title>devs-des1re - Portfolio</title>
    ...
    <main class="max-w-[1500px] mx-auto">
        <section class="flex flex-col-reverse md:flex-row items-center justify-between px-5 md:px-12 my-12 gap-10">
            <div class="flex-[5] min-w-[300px]">
                ...
                <p class="text-[#4D4D4D] leading-relaxed">
            ...
            <div class="w-full md:flex-[1] flex justify-center md:justify-end">
                <img src="images/pfp.png" alt="devs_des1re's pfp not loading :(" class="w-64 md:w-[350px] rounded-full object-cover flex-shrink-0">
            </div>
        </section>

        <section id="skills" class="px-5 md:px-12 mb-24">
            <h2 class="text-2xl md:text-3xl font-bold text-center mb-4">Skills</h2>
            <div class="text-center mb-6 text-[#4D4D4D]">
                These are all my coding skills! These are the languages I can code in and indicate my level. <br> This is how you can identify:
                <ul class="list-disc list-inside mb-8 space-y-2 text-[#4D4D4D]">
                    <li><strong class="text-[#FF0000]">Red:</strong> Indicates I only know the basics</li>
                    <li><strong class="text-[#FF7700]">Orange:</strong> I'm able to intermediate coding</li>
                    <li><strong class="text-[#007700]">Green:</strong> I'm very advanced in that language</li>
                </ul>
            </div>

            <div class="flex flex-wrap justify-center gap-4">                
                <div class="my-auto">
                    <div class="flex items-center gap-2 w-40 p-3 mb-5 border border-[#FF7700] rounded-md">
                ...
                <div class="my-auto">
                    <div class="flex items-center gap-2 w-40 p-3 mb-5 border border-[#007700] rounded-md">
