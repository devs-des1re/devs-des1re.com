...
<head>
    ...
    <title>devs-des1re - Error 404</title>
    ...
    <main class="flex flex-col items-center justify-center min-h-[60vh] px-10 py-10">
        <div class="flex flex-col items-center text-center mx-auto">
            <div class="flex flex-col items-center mx-auto text-center">
                ...
                <h1 class="mt-3 text-2xl font-semibold text-[#1C1C1C] md:text-3xl">Page not found</h1>
                <p class="mt-4 text-[#4D4D4D]">The page you are looking for doesn't exist. Here are some helpful links:</p>
